              ...
              <AnimatePresence>
                {selectedFiles.map(path => (
                  <motion.li
                    ...
                    className="group flex items-center gap-2 p-2 rounded-md bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-900 mb-1 hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors"
                  >
